...
import CreativeDashboard from "@/components/ui/CreativeDashboard";
...
const VeoStudio: React.FC = () => {
  ...
  useEffect(() => {
    const handleProductUpdate = (event: CustomEvent) => {
      ...
      // Update prompt based on product selection
      if (event.detail.prompt) {
        setPrompt(event.detail.prompt);
      }

      // Handle image file input (for visual generation)
...
Check your Google Cloud Console for quota details.`;
  ...
  return (
    <CreativeDashboard
      ...
      setSavedVisuals={setSavedVisuals}
      ...
      buildCompletePrompt={buildCompletePrompt}
